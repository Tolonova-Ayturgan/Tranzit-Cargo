    ...
    >
      ...
      <AboutUs>
        <TextWrapper variants={animateOnAxis_X} custom={3}>
          ...
          комплексные решения для перевозок сборных грузов и отдельными машинами
          из Бишкека во все города России и обратно. <br />
          <br />
          Если Вам требуется доставить крупную партию груза - мы выделим под Ваш
          груз персональный транспорт в любое удобное для Вас время. <br />{" "}
          <br />
